...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setConfirmation($v)
    {
        ...
        if ($this->confirmation !== $v) {
            $this->confirmation = $v;
            $this->modifiedColumns[UserTableMap::COL_CONFIRMATION] = true;
        }
    ...
    /**
     * Set the value of [regdate] column.
     *
     * @param int $v new value
     * @return $this|\User The current object (for fluent API support)
     */
    public function setRegisterDate($v)
    {
        ...
        if ($this->regdate !== $v) {
            $this->regdate = $v;
            $this->modifiedColumns[UserTableMap::COL_REGDATE] = true;
        }
    ...
    public function setGroupID($v)
    {
        ...
        if ($this->groupid !== $v) {
            $this->groupid = $v;
            $this->modifiedColumns[UserTableMap::COL_GROUPID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserTableMap::translateFieldName('Activated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->activated = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserTableMap::translateFieldName('Confirmation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->confirmation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('RegisterDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->regdate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UserTableMap::translateFieldName('LastLogin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lastlogin = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UserTableMap::translateFieldName('GroupID', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_CONFIRMATION)) {
            $modifiedColumns[':p' . $index++]  = 'Confirmation';
        }
        if ($this->isColumnModified(UserTableMap::COL_REGDATE)) {
            $modifiedColumns[':p' . $index++]  = 'RegDate';
        }
        if ($this->isColumnModified(UserTableMap::COL_LASTLOGIN)) {
            $modifiedColumns[':p' . $index++]  = 'LastLogin';
        }
        if ($this->isColumnModified(UserTableMap::COL_GROUPID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Activated':
                        ...
                        break;
                    case 'Confirmation':
                        $stmt->bindValue($identifier, $this->confirmation, PDO::PARAM_STR);
                        break;
                    case 'RegDate':
                        $stmt->bindValue($identifier, $this->regdate, PDO::PARAM_INT);
                        break;
                    case 'LastLogin':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getActivated(),
            $keys[5] => $this->getConfirmation(),
            $keys[6] => $this->getRegisterDate(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setActivated($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setConfirmation($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setRegisterDate($arr[$keys[6]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_CONFIRMATION)) {
            $criteria->add(UserTableMap::COL_CONFIRMATION, $this->confirmation);
        }
        if ($this->isColumnModified(UserTableMap::COL_REGDATE)) {
            $criteria->add(UserTableMap::COL_REGDATE, $this->regdate);
        }
        if ($this->isColumnModified(UserTableMap::COL_LASTLOGIN)) {
            $criteria->add(UserTableMap::COL_LASTLOGIN, $this->lastlogin);
        }
        if ($this->isColumnModified(UserTableMap::COL_GROUPID)) {
            $criteria->add(UserTableMap::COL_GROUPID, $this->groupid);
        }
