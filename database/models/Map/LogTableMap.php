...
class LogTableMap extends TableMap
{
     ...
     */
    const COL_LOCATION = 'log.location';

    /**
     * the column name for the url field
     */
    const COL_URL = 'log.url';
    ...
    /**
     * the column name for the request_info field
     */
    const COL_REQUEST_INFO = 'log.request_info';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Location', 'Url', 'Time', 'RequestInfo', ),
        self::TYPE_CAMELNAME     => array('id', 'location', 'url', 'time', 'requestInfo', ),
        self::TYPE_COLNAME       => array(LogTableMap::COL_ID, LogTableMap::COL_LOCATION, LogTableMap::COL_URL, LogTableMap::COL_TIME, LogTableMap::COL_REQUEST_INFO, ),
        self::TYPE_FIELDNAME     => array('id', 'location', 'url', 'time', 'request_info', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Location' => 1, 'Url' => 2, 'Time' => 3, 'RequestInfo' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'location' => 1, 'url' => 2, 'time' => 3, 'requestInfo' => 4, ),
        self::TYPE_COLNAME       => array(LogTableMap::COL_ID => 0, LogTableMap::COL_LOCATION => 1, LogTableMap::COL_URL => 2, LogTableMap::COL_TIME => 3, LogTableMap::COL_REQUEST_INFO => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'location' => 1, 'url' => 2, 'time' => 3, 'request_info' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('location', 'Location', 'VARCHAR', true, 100, null);
        $this->addColumn('url', 'Url', 'VARCHAR', true, 300, null);
        $this->addColumn('time', 'Time', 'TIMESTAMP', true, null, null);
        $this->addColumn('request_info', 'RequestInfo', 'VARCHAR', true, 500, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LogTableMap::COL_LOCATION);
            $criteria->addSelectColumn(LogTableMap::COL_URL);
            $criteria->addSelectColumn(LogTableMap::COL_TIME);
            $criteria->addSelectColumn(LogTableMap::COL_REQUEST_INFO);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.location');
            $criteria->addSelectColumn($alias . '.url');
            $criteria->addSelectColumn($alias . '.time');
            $criteria->addSelectColumn($alias . '.request_info');
        }
    }
