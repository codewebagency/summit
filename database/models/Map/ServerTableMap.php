...
class ServerTableMap extends TableMap
{
     ...
     */
    const COL_IP = 'server.ip';

    /**
     * the column name for the celery_username field
     */
    const COL_CELERY_USERNAME = 'server.celery_username';

    /**
     * the column name for the celery_password field
     */
    const COL_CELERY_PASSWORD = 'server.celery_password';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Ip', 'CeleryUsername', 'CeleryPassword', ),
        self::TYPE_CAMELNAME     => array('id', 'ip', 'celeryUsername', 'celeryPassword', ),
        self::TYPE_COLNAME       => array(ServerTableMap::COL_ID, ServerTableMap::COL_IP, ServerTableMap::COL_CELERY_USERNAME, ServerTableMap::COL_CELERY_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'ip', 'celery_username', 'celery_password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Ip' => 1, 'CeleryUsername' => 2, 'CeleryPassword' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'ip' => 1, 'celeryUsername' => 2, 'celeryPassword' => 3, ),
        self::TYPE_COLNAME       => array(ServerTableMap::COL_ID => 0, ServerTableMap::COL_IP => 1, ServerTableMap::COL_CELERY_USERNAME => 2, ServerTableMap::COL_CELERY_PASSWORD => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'ip' => 1, 'celery_username' => 2, 'celery_password' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('ip', 'Ip', 'CHAR', true, 20, null);
        $this->addColumn('celery_username', 'CeleryUsername', 'VARCHAR', true, 50, null);
        $this->addColumn('celery_password', 'CeleryPassword', 'VARCHAR', true, 60, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ServerTableMap::COL_IP);
            $criteria->addSelectColumn(ServerTableMap::COL_CELERY_USERNAME);
            $criteria->addSelectColumn(ServerTableMap::COL_CELERY_PASSWORD);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.ip');
            $criteria->addSelectColumn($alias . '.celery_username');
            $criteria->addSelectColumn($alias . '.celery_password');
        }
    }
