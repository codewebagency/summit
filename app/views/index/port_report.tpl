...
{% block title %}Port Report{% endblock %}
{% block content %}
...
<h3 style="margin-top:50px;padding-left: 20px;">Port results for {{ url|escape }}</h3>
<p>&nbsp;</p>
...
jQuery.ajax({
    url: BASE_URL + 'index/show_port_table',
    type: 'get',
