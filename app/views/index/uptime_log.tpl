...
{% block title %}Uptime Log{% endblock %}
{% block content %}
...
<h3 style="margin-top:50px;padding-left: 20px;">Log History
    For {{ info[0].url|escape }}</h3>
<p>&nbsp;</p>
<div class="log-table-wrapper">
    <div id="table-in-pagination" data-info='{{ info|json_encode() }}'>
    </div>
</div>
{% endblock %}
